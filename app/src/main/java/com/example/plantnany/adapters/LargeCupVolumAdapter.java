...
public class LargeCupVolumAdapter extends RecyclerView.Adapter<LargeCupVolumAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public LargeCupVolumAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.row_item_cup_volume, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull LargeCupVolumAdapter.ViewHolder holder, int position) {

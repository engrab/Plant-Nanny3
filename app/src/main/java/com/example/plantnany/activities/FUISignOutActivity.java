...
public class FUISignOutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f_u_i_sign_out);
        ...
        AuthUI.getInstance()
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    public void onComplete(@NonNull Task<Void> task) {
                        // ...
                        Toast.makeText(FUISignOutActivity.this, "Sign Out successfully", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(FUISignOutActivity.this, FUISignOutActivity.class));
                        finish();
                    }
                });
    ...
    public void checkCurrentUser() {
        ...
        if (user != null) {
            // User is signed in
            Log.d(TAG, "checkCurrentUser: "+user.getEmail());
            tvEmail.setText(user.getPhoneNumber()+"\n"+
                    ...
                    user.getTenantId()+"\n"+
                    user.getUid()+"");
            Log.d(TAG, "checkCurrentUser: "+user.getPhotoUrl());
//            if (user.getPhotoUrl() != null)
//                Glide.with(this).load(user.getPhotoUrl()).into(imageView);

        } else {
            startActivity(new Intent(this, FUISignInActivity.class));
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(FUISignOutActivity.this, "Authentication failed.",
        ...
        PhoneAuthOptions options = PhoneAuthOptions.newBuilder(auth)
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    public void onCodeSent(String verificationId,
                        ...
                        FUISignOutActivity.this.enableUserManuallyInputCode();
                    }
